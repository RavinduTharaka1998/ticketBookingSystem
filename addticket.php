    ...
    <body>
        ...
        <div class = "top">
            <div class = "top-left">
                ...
                <h1> <a href="dashboard.php"> Online Ticket Booking  </a></h1>
            </div>
            <div class = "top-right">
                <div class = "menu">
        ...
        <header class = "header">
            <div class = "header-inner">
                    <h2><marquee class = "blink" behavior = " alternate" direction="left">...Buy Your Tickets...</marquee></h2>
                    <br>
                    <form action = "backend/ticketAddServlet.php" method = "POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control"  aria-describedby="emailHelp" name = "phone" id = "phone" onInput = "checkPhone()" required >
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control"  aria-describedby="emailHelp" name = "noOfA" id = "adult" onInput = "checkAdult()"required >
                            <span style="color: red;" id = "check_adult"></span>
                        </div>

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">No of Child</label>
                            <input type="number" class="form-control"  aria-describedby="emailHelp" name = "noOfC" id = "child" onInput = "checkChild()"required >
                        ...
                        <button type="submit" class="btn btn-primary" name = "addticket">Reserve</button>
                    </form>
                <br><br>
            </div>
        </header>
